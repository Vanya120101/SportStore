...
internal class PageLinkTagHelperTests
{
	...
	public void Can_Generate_Page_Links()
	{
		...
		urlHelperFactory.Setup(m => m.GetUrlHelper(It.IsAny<ActionContext>())).Returns(urlHelper.Object);
		...
		//Assert
		var assert = string.Format(@"<a href=""Test/Page1"">1</a>"
									+ @"<a href=""Test/Page2"">2</a>"
									+ @"<a href=""Test/Page3"">3</a>");
		Assert.That(output.Content.GetContent(), Is.EqualTo(assert));
	}
}
